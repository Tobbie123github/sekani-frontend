...
const Dashboard = () => {
  ...
  const handleNextImage = (itemId) => {
    setImageIndexes((prevIndexes) => {
      const currentImages =
        items.find((item) => item._id === itemId)?.images || [];
  ...
  return (
    <div className="mt-[6rem] ">
      ...
      <div className="flex md:p-6 flex-col md:flex-row justify-between  items-center  rounded-lg shadow-md mb-6">
        <h1 className="dark:text-gray-300 text-3xl  font-bold text-gray-800 mb-4 md:mb-0">
          Image Dashboard
        </h1>
              ...
              <div className="relative h-48 overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://placehold.co/600x400/E5E7EB/6B7280?text=Error";
                  }}
                />
