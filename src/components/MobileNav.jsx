    ...
    <nav className="text-primary dark:text-gray-300 xl:hidden">
      ...
      >
        <div
          ...
          className="text-4xl flex gap-3 items-center absolute z-30 left-4 top-14 text-primary cursor-pointer"
        >
          <IoMdClose />
          <div className="cursor-pointer text-black dark:text-white p-6">
            <IoColorPalette
              className="cursor text-3xl text-[#AF4C0F]"
              onClick={(e) => {
                e.stopPropagation(); // prevent closing when clicking palette
